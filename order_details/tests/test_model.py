...
class OrderDetailTest(TestCase):
    ...
    def setUpTestData(cls) -> None:
        ...
        cls.orderdetail = OrderDetails.objects.create(**cls.orderdetail_test, order=cls.order, product=cls.product)

    def test_orderdetail_fields(self):

        self.assertEqual(self.orderdetail.final_price, self.orderdetail_test["final_price"], 'verificando field de final price')
        self.assertEqual(self.orderdetail.quantity_in_order, self.orderdetail_test["quantity_in_order"], 'verificando quantity_in_order')
